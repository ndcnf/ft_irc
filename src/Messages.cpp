...
void	Server::first_message( Client *client) {
	...
	std::string    msg = "001 " + client->getNick() + "\033[34m*: " + "\033[34mWelcome on the MoIRes Connection Server " + "!~" + client->getNick() + "@" + client->getHostname() + client->getNick() + END_SEQUENCE + RES;
